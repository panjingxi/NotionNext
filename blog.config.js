...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JingxiPan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Coder，天外人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jingxi.us.kg', // 网站地址
