const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://jingxi.us.kg' }
  ],
  ...
  HEO_HERO_TITLE_3: 'JingxiPan',
  HEO_HERO_TITLE_4: '',
  HEO_HERO_TITLE_5: '',
  HEO_HERO_TITLE_LINK: 'https://jingxi.us.kg',
  // 英雄区遮罩文字
  HEO_HERO_COVER_TITLE: '随便逛逛',

  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '推荐', url: '/tag/推荐' },
  HEO_HERO_CATEGORY_2: { title: '分享', url: '/tag/分享' },
  ...
  HEO_INFO_CARD_URL2: 'https://github.com/panjingxi',
  HEO_INFO_CARD_ICON2: 'fab fa-github',
  HEO_INFO_CARD_URL3: 'https://jingxi.us.kg',
